(function($) {
    ...
    PropertiesObject.prototype.fill = function(properties) {
        var $properties = $('<form role=\'form\'></form>'),
            $group,
            $field,
            $removeButton,
            options = ''
        ...
        $removeButton = $('<a href class=\'banner-remove-text btn\'></a>');
    ...
    Basic.prototype._init = function(options) {
        var that = this;
    ...
    $.fn.showBanner = function(unparsed, additional) {
        var $obj = $('<div>'),
            $this = $(this),
            options = this.val(),
            base;

        unparsed = unparsed || options;

        options = JSON.parse(unparsed);
